...
_jolts_. Always prepared, you make a list of all of the joltage adapters in your bag.
...
With these adapters, your device's built-in joltage adapter would be rated for `19 + 3 = _22_` jolts, 3 higher than the
